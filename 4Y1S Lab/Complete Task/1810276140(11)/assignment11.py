...
def main():
    ...
    my_filter = np.array((ncols,nrows),dtype=np.float32)
    
    #print("cent :",centered_ftimg.shape)
    ...
    figpath = 'C:\\Users\\acer\\Desktop\\Waterfall\\Digital_Image_Processing\\output.png'
